...
use tests\unit\Team3\PayU\Order\Transformer\UserOrder\Strategy\Model\ProductModel;
use tests\unit\Team3\PayU\Order\Transformer\UserOrder\Strategy\Model\UserOrderModelWithPrivateMethods;
use tests\unit\Team3\PayU\Order\Transformer\UserOrder\Strategy\Model\UsersProductCollectionModel;
...
class ProductCollectionTransformerTest extends \Codeception\TestCase\Test
{
    ...
    private function assertExceptionWhenProductsAreNotTraversable(
        ...
        $this->setExpectedException('Team3\PayU\Order\Transformer\UserOrder\UserOrderTransformerException');
    ...
    private function assertSingleProduct($product)
    {
        $this->assertInstanceOf(
            'Team3\PayU\Order\Model\Products\ProductInterface',
            $product
        );
