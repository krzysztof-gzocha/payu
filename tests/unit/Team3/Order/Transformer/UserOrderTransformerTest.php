<?php
namespace Team3\Order\Transformer;
...
class UserOrderTransformerTest extends \Codeception\TestCase\Test
{
    ...
    {
        $extractor = $this
            ->getMock('\Team3\PropertyExtractor\ExtractorInterface');
    ...
    private function getExtractorResult()
    {
        $extractorResult = $this
            ->getMockBuilder('\Team3\PropertyExtractor\ExtractorResult')
    ...
    {
        $strategy = $this
            ->getMock('\Team3\Order\Transformer\UserOrder\Strategy\UserOrderTransformerStrategyInterface');
