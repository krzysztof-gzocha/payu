...
namespace spec\Team3\PayU\Order\Transformer\UserOrder;
 ...
 * @package spec\Team3\PayU\Order\Transformer\UserOrder
...
class UserOrderTransformerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Team3\PayU\Order\Transformer\UserOrder\UserOrderTransformer');
    }
    ...
    protected function getAnnotationsExtractorResults()
    {
        $extractorResultProphecy = $this->prophet
            ->prophesize('Team3\\PayU\\PropertyExtractor\\ExtractorResult');
