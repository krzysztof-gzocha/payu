...
class BuyerInSeparateEntityTransformerSpec extends ObjectBehavior
{
    public function it_is_initializable()
    {
        $this->shouldHaveType('Team3\Order\Transformer\UserOrder\Strategy\BuyerInSeparateEntityTransformer');
    }
