...
namespace spec\Team3\Order\Transformer\UserOrder\Strategy\ShippingMethod;
 ...
 * @package spec\Team3\Order\Transformer\UserOrder\Strategy\ShippingMethod
...
class ShippingMethodCollectionTransformerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Team3\Order\Transformer\UserOrder\Strategy\ShippingMethod\ShippingMethodCollectionTransformer');
    }
